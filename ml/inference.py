...
#front_image, side_image, top_image, scad_path, openscad_path, output_stl
    ...
    weights_path = "ml/autoencoder_weights_10.pth"
...
def execute_algo(file_top, file_side, file_front):
    MODEL_NAME = '00011254'
    execute(front_image=file_front, side_image=file_side, top_image=file_top,
             scad_path="output/inference_scad.scad", openscad_path="ml/openscad.exe",
               output_stl="output/inference_stl.stl")
#front_image, side_image, top_image, scad_path, openscad_path, output_stl
# execute("backend/misc/00000000_f.png", 
#        "backend/misc/00000000_r.png", 
#        "backend/misc/00000000_t.png",
#         "output/inference_scad.scad",
#         "ml/openscad.exe",
#         "output/inference_stl.stl"
#         )